...
@EnableJpaRepositories(basePackages = "net.palm7.raa.repository", excludeFilters = @ComponentScan.Filter(classes = Exclude.class))
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("net.palm7.raa.model");
